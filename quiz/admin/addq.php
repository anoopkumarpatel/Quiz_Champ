...
<div class="col-sm-6">
<h3 style="color:;" class="mt-2" style="margin-left:200px;"><b>Add</b> Question
   ...
   <div class="col-sm-10 cont">
	 ...
	 <b style="font-weight:bold;color:white;margin-top:0px;letter-spacing:4px;font-size:20px;">Question:</b>
	   ...
	   <select class="form-control" name="type" required="true">
		...
		<br/>
		<br/>
		<input type="submit" value="ADD+ >>" name="addq" class="btn btn-success" style="width:300px;height:40px;float:right;font-weight:bold;font-size:20px;">
	 </form>
   </div>
</div>
</div>
...
include("../connection.php");
$query="insert into question(question,option_a,option_b,option_c,option_d,ans,type,level,addby,date)values('$ques','$opta','$optb','$optc','$optd','$ans','$type','$level','$name','$date')";
if(mysqli_query($conn,$query))
{
echo"<script>alert('add Successfully');window.location.href='addq.php'</script>";
}
else
{
