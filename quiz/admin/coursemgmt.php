...
<div class="col-sm-6">
<h3 style="color:;" class="mt-2" style="margin-left:200px;"><b>Cource</b> Management
...
<td>UPDATE</td>
	...
	<td><?php echo $row['cources'];?></td>
	<td><?php echo $row['descr'];?></td>
	<td><?php echo $row['addby'];?></td>
	<td><?php echo $row['date'];?></td>

	<td><a href="deletecourse.php?id=<?php echo $row['id'];?>" style="color:#FF0000;">Delete</a></td>
	<td><a href="updatecourse.php?id=<?php echo $row['id'];?>" style="color:#FF0000;">Update</a></td>
</tr>
   <?php
}
?>
