...
<div class="col-sm-6">
<h3 style="color:;" class="mt-2" style="margin-left:200px;"><b>Add/Remove</b> Admin
...
<td>UPDATE</td>
	...
	<td><a href="deleteadmin.php?id=<?php echo $row['userid'];?>" style="color:#FF0000;">Delete</a></td>
	<td><a href="updateadmin.php?id=<?php echo $row['userid'];?>" style="color:#FF0000;">Update</a></td>
</tr>
   <?php
$a++;
}
