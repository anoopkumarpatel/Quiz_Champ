...
<div class="col-sm-6">
<h3 style="color:;" class="mt-2" style="margin-left:200px;"><b>User Contact us </b> Message
...
<b>Logout</b>
 ...
 <?PHP
    ...
    <tr>
	 ...
	 <td><a href="deletecontactmessage.php?id=<?php echo $row['sr'];?>" style="color:#FF0000;">Delete</a></td>
    </tr>
	 <?php
$a++;
}
