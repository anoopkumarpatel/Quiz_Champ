...
<div class="col-sm-6">
<h3 style="color:;" class="mt-2" style="margin-left:200px;"><b>Message Management</b> Course
...
<b>Logout</b>
   ...
   <div class="col-sm-10 cont">
     <div class="container col-sm-3 text-center mx-auto text-white" style="margin-top:200px;">
	    <div class="row mt-5"><a href="msg.php"><button class="btn btn-primary">MESSAGE >>>></button></a></div>
		<div class="row mt-5"><a href="feed.php"><button class="btn btn-success">FEEDBACK >>>></button></a></div>
		<div class="row mt-5"><a href="forget.php"><button class="btn btn-success">Forget Password >>>></button></a></div>
	 </div>
   </div>
</div>
</div>
